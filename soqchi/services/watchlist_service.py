...
if TYPE_CHECKING:
    ...
    from soqchi.api.schemas import PersonCreate, PersonOut, PersonPatch, PersonPhotoOut
...
def _photo_embs(s: Session, person_id: uuid.UUID) -> list[list[float]]:
    from soqchi.db.models import PersonPhoto
...
def list_persons(category: str | None = None) -> list[PersonOut]:
    from soqchi.api.schemas import PersonOut
    from soqchi.db.models import Person, PersonPhoto, Track
...
def enroll_person(
    ...
    from soqchi.db.models import Person, PersonPhoto
...
def list_photos(person_id: uuid.UUID) -> list[PersonPhotoOut]:
    from soqchi.api.schemas import PersonPhotoOut
    from soqchi.db.models import PersonPhoto
