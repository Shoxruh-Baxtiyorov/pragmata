...
# --- привязка чата к организации (мультиаренда) ---
BIND_USAGE = (
    "Отправьте код привязки: /bind КОД\n"
    "Код берётся в разделе «Настройки» вашего дашборда."
)
BIND_OK = "Готово: чат привязан к вашему объекту. Сюда будут приходить тревоги."
BIND_BAD_CODE = "Код не найден или уже использован. Сгенерируйте новый в дашборде."
